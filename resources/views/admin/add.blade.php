        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Form Data Jurnal Komputasi</h5>
                </div>
                <div class="ibox-content">
                    <form action="{{ route('jurnal.add')}}" method="post" enctype="multipart/form-data" onkeypress="return event.keyCode != 13;">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" placeholder="Judul Jurnal" class="form-control" name="judul_jurnal" required> 
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 col-form-label"><b>Nama Penulis</b></label>
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Nama Penulis" class="form-control"  name="nama_penulis" required> 
                                </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 col-form-label"><b>Abstrak</b></label>
                                <div class="col-lg-10">
                                    <textarea  rows="10"  type="text" placeholder="Abstrak" class="form-control"  name="abstrak" required></textarea>
                                </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 col-form-label"><b>Kata Kunci</b></label>
                                <div class="col-lg-10">
                                    <input id="tagsinput" class="tagsinput form-control" type="text"  name="kata_kunci" required/>
